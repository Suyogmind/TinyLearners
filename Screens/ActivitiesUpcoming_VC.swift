...
class ActivitiesUpcoming_VC: UIViewController, UITableViewDelegate, UITableViewDataSource, businessLogicLayerDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    /**************************************************************************/
    //MARK:-  Api Call :- parent/upcomingActivities
    /**************************************************************************/
    ...
    func upcomingActivities_InvokeAPI() {
        ...
        if !reachability.isReachable
        {
            ...
            HalperBL.upcomingActivitiesAPICall(Parameter)
            
            return
        }
    }
    
    func upcomingActivitiesAPICallFinished(_ dict : NSDictionary) {
    ...
    func upcomingActivitiesAPICallMessage(_ massge : String) {
        hideActivityIndicator(uiView: navi!.view)
    ...
    func upcomingActivitiesAPICallError(_ error: Error) {
        hideActivityIndicator(uiView: navi!.view)
...
// Table view
extension ActivitiesUpcoming_VC {
